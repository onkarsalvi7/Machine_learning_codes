# -*- coding: utf-8 -*-
"""
Created on Tue Apr 17 14:03:37 2018
...
from detection_utils import read_classes, read_anchors, generate_colors, preprocess_image, draw_boxes, scale_boxes
...
    """
    ...
    # Calculate the (y1, x1, y2, x2) coordinates of the intersection of box1 and box2 and its Area.
...
#---------------Loading Classnames, anchors and specifying image shape----------#
class_names = read_classes("model_data/coco_classes.txt")
anchors = read_anchors("model_data/yolo_anchors.txt")
image_shape = (720., 1280.)  

#---------------Creating a Graph(sess)-----------------------------#
